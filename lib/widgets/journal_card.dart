          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (todo.time?.isNotEmpty == true || todo.mood?.isNotEmpty == true)
                  Row(
                    children: [
                      const Icon(Icons.access_time, size: 14, color: Colors.black),
                      const SizedBox(width: 4),
                      Text('Created: ${todo.time?.isNotEmpty == true ? todo.time! : 'N/A'}', style: const TextStyle(fontSize: 12)),
                      if (todo.mood?.isNotEmpty == true) ...[
                        const SizedBox(width: 8),
                        Text('Mood: ${todo.mood!}', style: const TextStyle(fontSize: 12)),
                      ],
                    ],
                  ),
              ],
