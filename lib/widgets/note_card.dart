          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                Text(
                  todo.type,
                  style: TextStyle(color: Colors.purple.shade800, fontWeight: FontWeight.w600),
                ),
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (todo.description?.isNotEmpty == true || todo.content?.isNotEmpty == true)
                  Padding(
                ...
                if (todo.lastCompletedDate?.isNotEmpty == true || todo.time?.isNotEmpty == true)
                  Row(
                    children: [
                      const Icon(Icons.update, size: 14, color: Colors.black),
                      const SizedBox(width: 4),
                      Text(
                        'Last Updated: ${todo.lastCompletedDate?.isNotEmpty == true ? todo.lastCompletedDate! : 'N/A'} ${todo.time?.isNotEmpty == true ? todo.time! : ''}',
